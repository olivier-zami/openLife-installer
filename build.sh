...
git clone --recurse-submodules --branch refacto https://github.com/olivier-zami/OneLife.git .
git pull --tags
...
#mgPath="../third_party/minorGems"
mgPath2="../.."

# use partial makefiles from minorGems project
makefileMinorGems="$mgPath2/build/Makefile.minorGems"
makefileMinorGemsTargets="$mgPath2/build/Makefile.minorGems_targets"
...
echo "cat :\n$(pwd)$platformMakefile\n$(readlink -f "$(pwd)$commonMakefile") \n$(pwd)$makefileMinorGems \n$(pwd)$makefileAll \n$(pwd)$makefileMinorGemsTargets"
